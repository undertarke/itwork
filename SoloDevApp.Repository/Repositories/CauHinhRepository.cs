...
namespace SoloDevApp.Repository.Repositories
{
    ...
    {
       /* Task<CauHinh> Off_CheckUserFace(string idFace);*/
    ...
    public class CauHinhRepository : RepositoryBase<CauHinh>, ICauHinhRepository
    {
        ...
        public CauHinhRepository(IConfiguration configuration)
            : base(configuration)
        {
        }


     /*   public async Task<CauHinh> Off_CheckUserFace(string idFace)
        {
